...
> `smoke:ui:full` 一级同时执行 **44 项**界面断言（断言内容见 [docs/TEST_CASES.md](docs/TEST_CASES.md) 的 A7 / A8 / B0 节，
...
npm run smoke:ui:file      # 上一项 + 加载真实视频后再截图（32 项检查）
